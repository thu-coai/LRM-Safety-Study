...
class GRPOConfig(TrainingArguments):
    ...
    Parameters:
        ...
        reward_tag_config (`dict` or `None`, *optional*, defaults to `None`):
            Configuration for different reward sets based on reward tags. Format:
            `{'tag_name': {'reward_funcs': [func_names], 'weights': [weights]}}`
    ...
    reward_tag_config: Optional[dict] = field(
        default=None,
        metadata={
            "help": "Configuration for different reward sets based on reward tags. Format: "
            "{'tag_name': {'reward_funcs': [func_names], 'weights': [weights]}}"
        },
    )
